...
class YellowSign extends Faction {
    YellowSign(String name, FactionType faction, Core core) {
        ...
        entitySetsList.add(new EntitySet(core, "Undead", Category.Monster, faction, entityIcons.get(1), 6, EntitySet.constFunc(0), EntitySet.constFunc(0)));
        entitySetsList.add(new EntitySet(core, "Byakhee", Category.Monster, faction, entityIcons.get(2), 4, EntitySet.constFunc(0), EntitySet.constFunc(0)));
        entitySetsList.add(new EntitySet(core, "King in Yellow", Category.GOO, faction, entityIcons.get(3), 1, EntitySet.constFunc(0), EntitySet.constFunc(0)));
        entitySetsList.add(new EntitySet(core, "Hastur", Category.GOO, faction, entityIcons.get(4), 1, EntitySet.constFunc(0), EntitySet.constFunc(0)));
